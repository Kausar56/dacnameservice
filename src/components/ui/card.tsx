  ...
  "rounded-xl text-card-foreground transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        elevated:
          "bg-surface-elevated border border-border shadow-elevated",
        gradient: "gradient-border shadow-glass",
        outline:
          "bg-transparent border border-border hover:border-primary/30",
        ghost: "bg-transparent",
        interactive:
          "glass shadow-glass hover:bg-white/[0.04] hover:border-primary/20 cursor-pointer",
      },
      padding: {
        none: "",
        sm: "p-4",
